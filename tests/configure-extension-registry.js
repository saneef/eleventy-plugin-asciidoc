...
test("Render with shout extension", async (t) => {
  const elev = new Eleventy(
    "./tests/fixtures/configure-extension-registry/src",
    "./tests/fixtures/configure-extension-registry/_site",
    {
      configPath:
        "./tests/fixtures/configure-extension-registry/eleventy.config.js",
    },
  );
